...
TransportCompanyUIHelper::TransportCompanyUIHelper(TransportationCompany* transportationCompany)
{
    this->transportCompany = transportationCompany;
}

void TransportCompanyUIHelper::populateTableView(QTableWidget* tableWidget) {
    ...
    filename=DATA_FOLDER_PATH + transportCompany->GetUsername()+"_transactions.csv";
